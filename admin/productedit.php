         ...
         <form action="" method="post" enctype="multipart/form-data">
            <table class="form">
				...
				<tr>
                    ...
                    <td>
                        <select id="select" name="gender">
                            ...
                            ?>
                            <option selected value="0">Đồng hồ nam</option>
                            <option value="1">Đồng hồ nữ</option>
                            <?php
                            }else{
                            ?>
                                <option value="0">Đồng hồ nam</option>
                                <option selected value="1">Đồng hồ nữ</option>
                            <?php
                            }
                            ?>
                        </select>
                ...
                <tr>
                    ...
                    <td>
                        <img src="uploads/<?php echo $result_product['image'] ?>" width="80" height="80"><br>
				...
				<tr>
                    ...
                    <td>
                        <select id="select" name="type">
                            ...
                            ?>
                            <option selected value="0">Đồng hồ giá rẻ</option>
                            <option value="1">Đồng hồ cao cấp</option>
                            <?php
                            }else{
                            ?>
                                <option value="0">Đồng hồ giá rẻ</option>
                                <option selected value="1">Đồng hồ cao cấp</option>
                            <?php
                            }
                            ?>
                        </select>
